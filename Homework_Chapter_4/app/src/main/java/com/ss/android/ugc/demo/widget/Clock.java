...
public class Clock extends View {
    ...
    private void drawHoursValues(Canvas canvas) {
        ...
        for (int i = 1; i <= 12; ++i) {
            int tmp = i*30;
            int startX = (int) (mCenterX + rPadded * Math.sin(Math.toRadians(tmp))) - 20;
            int startY = (int) (mCenterX - rPadded * Math.cos(Math.toRadians(tmp)))+20;
            canvas.drawText(Integer.toString(i), startX, startY, paint);
        }
    }
